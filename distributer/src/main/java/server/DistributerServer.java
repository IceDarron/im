...
public class DistributerServer {
    private static final Logger logger = LoggerFactory.getLogger(DistributerServer.class);
        ...
        bootstrap.bind(new InetSocketAddress(port)).addListener(new ChannelFutureListener() {
            public void operationComplete(ChannelFuture future)
                ...
                if (future.isSuccess()) {
                    ...
                    logger.info("[GateServer] Started Successed, registry is complete, waiting for client connection...");
                } else {
